...
public:
    ...
    inline static bool IsRGBAFormat(DXGI_FORMAT format);
    inline static bool IsRGBFormat(DXGI_FORMAT format);
    inline static bool IsRGFormat(DXGI_FORMAT format);
    inline static bool IsRFormat(DXGI_FORMAT format);
    inline static bool IsDepthFormat(DXGI_FORMAT format);
    inline static bool IsCompressedFormat(DXGI_FORMAT format);
    inline static bool IsStencilFormat(DXGI_FORMAT format);
...
inline bool Texture::IsRGBAFormat(DXGI_FORMAT format)
{
    switch (format)
    {
...
inline bool Texture::IsRGBFormat(DXGI_FORMAT format)
{
    switch (format)
    {
...
inline bool Texture::IsRGFormat(DXGI_FORMAT format)
{
    switch (format)
    {
...
inline bool Texture::IsRFormat(DXGI_FORMAT format)
{
    switch (format)
    {
...
inline bool Texture::IsDepthFormat(DXGI_FORMAT format)
{
    switch (format)
    {
...
inline bool Texture::IsStencilFormat(DXGI_FORMAT format)
{
    switch (format)
    {
    case DXGI_FORMAT_D32_FLOAT_S8X24_UINT:
